...
export const TopSongs = ({ songs }: { songs: any }) => (
  <Flex
    direction="column"
    maxW="2xl"
    width="full"
...
export const TopArtists = ({ artists }: { artists: any }) => (
  <Flex direction="column" maxW="xl" width="full" mx="auto" overflow="visible">
    <LineHeading alignSelf="center" mb="4">
      Top Artists
    </LineHeading>
    <SimpleGrid bg="transparent" columns={{ sm: 1, md: 3 }} spacing={5} my={5} p={5} width="full" overflow="visible" height="full">
...
export const RecentSongs = ({ songs }: { songs: any }) => (
...
export const CurrentlyPlaying = ({ song }: CurrentlyPlayingProps) => (
  <Flex direction="column" alignItems="center" width="full" mx="auto">
    ...
    {song?.isPlaying ? <SongCard song={song} titleCard isPlaying={song.isPlaying} /> : <Text>Nothing playing</Text>}
  </Flex>
)
